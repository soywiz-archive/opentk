...
namespace OpenTK.Platform.Windows
{
    ...
    {
        /// <summary>
        /// Initializes the map between VirtualKeys and OpenTK.Input.Key
        /// </summary>
        internal WinKeyMap()
        {
            ...
            // Map all other keys to OpenTK.Input.Key.Unknown
            for (int i = 0; i < 256; i++)
            {
                if (!this.ContainsKey((VirtualKeys)i))
                    this.Add((VirtualKeys)i, Key.Unknown);
            }
        }
    }
}
