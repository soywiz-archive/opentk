namespace OpenTK.Platform.Windows
{
    ...
    partial class Wgl
    {
        ...
        internal static class Imports
        {
            ...
            internal extern static int ChoosePixelFormat(IntPtr hDc, PixelFormatDescriptor pPfd);
            [System.Security.SuppressUnmanagedCodeSecurity()]
            [System.Runtime.InteropServices.DllImport(Wgl.Library, EntryPoint = "wglDescribePixelFormat", ExactSpelling = true)]
            internal extern static int DescribePixelFormat(IntPtr hdc, int ipfd, UInt32 cjpfd, PixelFormatDescriptor ppfd);
            [System.Security.SuppressUnmanagedCodeSecurity()]
            ...
            internal extern static Boolean SetPixelFormat(IntPtr hdc, int ipfd, PixelFormatDescriptor ppfd);
            [System.Security.SuppressUnmanagedCodeSecurity()]
            ...
            internal extern static Boolean DescribeLayerPlane(IntPtr hDc, int pixelFormat, int layerPlane, UInt32 nBytes, LayerPlaneDescriptor plpd);
            [System.Security.SuppressUnmanagedCodeSecurity()]
            ...
            [System.Security.SuppressUnmanagedCodeSecurity()]
            [System.Runtime.InteropServices.DllImport(Wgl.Library, EntryPoint = "wglUseFontBitmaps", ExactSpelling = true)]
            internal extern static Boolean UseFontBitmaps(IntPtr hDC, Int32 first, Int32 count, Int32 listBase);
            [System.Security.SuppressUnmanagedCodeSecurity()]
            [System.Runtime.InteropServices.DllImport(Wgl.Library, EntryPoint = "wglUseFontOutlinesA", ExactSpelling = true)]
            internal extern static Boolean UseFontOutlinesA(IntPtr hDC, Int32 first, Int32 count, Int32 listBase, float thickness, float deviation, GlyphMetrics glyphMetrics);
            [System.Security.SuppressUnmanagedCodeSecurity()]
            [System.Runtime.InteropServices.DllImport(Wgl.Library, EntryPoint = "wglUseFontOutlinesW", ExactSpelling = true)]
            internal extern static Boolean UseFontOutlinesW(IntPtr hDC, Int32 first, Int32 count, Int32 listBase, float thickness, float deviation, GlyphMetrics glyphMetrics);
            [System.Security.SuppressUnmanagedCodeSecurity()]
            [System.Runtime.InteropServices.DllImport(Wgl.Library, EntryPoint = "wglUseFontOutlines", ExactSpelling = true)]
            internal extern static Boolean UseFontOutlines(IntPtr hDC, Int32 first, Int32 count, Int32 listBase, float thickness, float deviation, GlyphMetrics glyphMetrics);
        }
    }
}
