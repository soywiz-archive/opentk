...
namespace OpenTK
{
    static public class Key
    {
        ...
        static public bool Enter
        {
            ...
            set { keys[(int)Keys.Enter] = value; }
        }

        static public bool Escape
        {
            get { return keys[(int)Keys.Escape]; }
            set { keys[(int)Keys.Escape] = value;  } 
        }
    }
