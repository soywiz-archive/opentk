...
namespace OpenTK.OpenGL.Platform
{
    public partial class X11Context : OpenTK.OpenGL.GLContext
    {
        ...
        public X11Context(Control c, ColorDepth color, int depth, int stencil)
            : base(c, color, depth, stencil, 0, false)
        {
            ...
            if (xplatui != null)
            {
                ...
                X11Api.XMapRaised(display, c.TopLevelControl.Handle);
        ...
        */
        ...
        {
            bool result = Glx.MakeCurrent(display, this.handle, x11context);
        ...
        {
            Glx.SwapBuffers(display, this.handle);
        }
        ...
        {
            return Glx.GetProcAddress(function_string);
        }
        /*
        ...
        */
        ...
        private void GrabPointer()
        {
            ...
            X11Api.ErrorCodes retval = X11Api.XGrabPointer(display, this.handle, true, 0,
                X11Api.GrabMode.Async, X11Api.GrabMode.Async,
                this.handle, IntPtr.Zero, 0);

            Console.WriteLine(retval.ToString());

            Console.Write("Grabbing keyboard... ");
            retval = X11Api.XGrabKeyboard(display, this.handle, true,
        ...
        public override List<DisplayMode> GetDisplayModes()
        {
